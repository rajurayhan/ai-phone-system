...
<head>
    ...
    <title>{{ config('app.name', 'Hive AI Phone') }}</title>
    ...
    <div class="email-container">
        ...
        <div class="footer">
            <div class="footer-content">
                <p>© {{ date('Y') }} Hive AI Phone. All rights reserved.</p>
                <p>This email was sent to you because you registered for a Hive AI Phone account.</p>
