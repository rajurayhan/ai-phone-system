...
@section('content')
    <h2>Welcome to SulusAI, {{ $user->name }}! 🎉</h2>
    ...
    <h3 style="color: #2d3748; margin: 30px 0 20px 0;">🚀 What You Can Do With SulusAI</h3>
    ...
    <p style="margin-top: 30px; font-size: 14px; color: #6c757d;">
        <strong>Note:</strong> If you did not create an account with SulusAI, please ignore this email. No further action is required.
    </p>
