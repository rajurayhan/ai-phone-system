...
@section('content')
    ...
    <p>Hello <strong>{{ $contact->first_name }}</strong>, thank you for reaching out to Hive AI Phone. We've received your message and will get back to you as soon as possible.</p>
    ...
    <div class="text-center mb-30">
        <a href="{{ config('app.url') }}/support" class="cta-button">
    ...
    <div class="card">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            <div style="background: #f0fff4; padding: 15px; border-radius: 8px; border: 2px solid #48bb78;">
                ...
                <p style="color: #4a5568;">Hive AI Phone@gmail.com</p>
            </div>
    ...
    <div class="text-center mt-30">
        <a href="{{ config('app.url') }}" class="secondary-button">
            🏠 Visit Website
        </a>
        <a href="{{ config('app.url') }}/pricing" class="secondary-button">
            💰 View Pricing
        </a>
    </div>
    
    <p style="margin-top: 30px; color: #4a5568;">
        Thank you for choosing Hive AI Phone! We're excited to help you with your voice AI needs.
    </p>
