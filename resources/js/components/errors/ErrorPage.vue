    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <div class="text-center">
        ...
        <div class="flex justify-center">
          <div v-if="settings.logo_url" class="h-12 w-auto">
        ...
        <div class="space-y-6">
          ...
          <div class="border-t border-gray-200 pt-6">
            ...
            <div class="flex space-x-3">
              <a 
                href="mailto:support@Hive AI Phone.com" 
...
export default {
  ...
  async created() {
    try {
      ...
      document.title = `${this.errorCode} - ${this.errorTitle} | ${this.settings.site_title || 'Hive AI Phone'}`
    } catch (error) {
      ...
      document.title = `${this.errorCode} - ${this.errorTitle} | Hive AI Phone`
    }
  }
}
</script> 