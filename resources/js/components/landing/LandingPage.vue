            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl"> 
                  ...
                  <span class="block text-primary-600 xl:inline"> {{ settings.company_name || 'sulus.ai' }} answers 24x7!</span> 
                </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="lg:text-center">
            ...
            <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need for {{ settings.company_name || 'sulus.ai' }}
            </p>
      ...
      <div class="bg-primary-700">
        <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p class="mt-4 text-lg leading-6 text-primary-200">
            Join thousands of businesses already using our {{ settings.company_name || 'sulus.ai' }} platform.
          </p>
...
export default {
  ...
  setup() {
    ...
    const loadSettings = async () => {
      try {
        ...
        settings.value = {
          ...
          company_email: 'support@sulus.ai.com'
        }
      }
    }
    ...
    onMounted(() => {
      ...
      const title = settings.value.site_title || 'sulus.ai'
      const tagline = settings.value.site_tagline || 'Never Miss a call Again sulus.ai answers 24x7!'
    ...
    return {
      ...
      contactEmail: computed(() => settings.value.company_email || 'sulus.ai@gmail.com'),
      handleLogoError,
      handleLogoLoad,
      handleBannerError,
      handleBannerLoad
