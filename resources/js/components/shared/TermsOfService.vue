    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white shadow-lg rounded-lg p-8">
        <div class="prose prose-lg max-w-none">
          ...
          <p class="mb-6">
            By accessing and using Hive AI Phone ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
          </p>

          <h2 class="text-2xl font-semibold text-gray-900 mb-4">2. Description of Service</h2>
          <p class="mb-6">
            Hive AI Phone provides voice AI assistant services, including but not limited to:
          </p>
          ...
          <p class="mb-6">
            The Service and its original content, features, and functionality are owned by Hive AI Phone and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
          </p>

          <h2 class="text-2xl font-semibold text-gray-900 mb-4">8. Limitation of Liability</h2>
          <p class="mb-6">
            In no event shall Hive AI Phone, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your use of the Service.
          </p>
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            <p class="mb-2"><strong>Email:</strong> support@Hive AI Phone.com</p>
...
export default {
  name: 'TermsOfService',
  async created() {
    await updateDocumentTitle('Terms of Service')
  }
}
</script>
